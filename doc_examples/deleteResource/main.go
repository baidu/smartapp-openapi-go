...
func main() {
	...
	reqParams := &openapi.DeleteResourceRequest{
		AccessToken: "20.1fa503ebfa2c445dda5b4a203c88001e.4612113.5784478373.664142-00772638", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		AppID:       12662853,                                                                 // 文档中对应字段：app_id，实际使用时请替换成真实参数
		Path:        "/pages/detail/detail?id=065485",                                         // 文档中对应字段：path，实际使用时请替换成真实参数
	}

	resp, err := openapi.DeleteResource(reqParams)
	if err != nil {
