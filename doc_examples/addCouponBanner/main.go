...
func main() {
	...
	reqParams := &openapi.AddCouponBannerRequest{
		AccessToken:     "20.466f86062a1382a0c2ad8c172838eb01.0326681.8127571543.277872-63387174", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Title:           "卡券标题",                                                                   // 文档中对应字段：title，实际使用时请替换成真实参数
		AppRedirectPath: "/test",                                                                  // 文档中对应字段：appRedirectPath，实际使用时请替换成真实参数
		CouponID:        "8310171845",                                                             // 文档中对应字段：couponId，实际使用时请替换成真实参数
		PicURL:          "/index/index",                                                           // 文档中对应字段：picUrl，实际使用时请替换成真实参数
	}

	resp, err := openapi.AddCouponBanner(reqParams)
	if err != nil {
