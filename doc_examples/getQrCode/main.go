...
func main() {
	...
	reqParams := &openapi.GetQrCodeRequest{
		AccessToken: "27.103f07068a1412a8c2ad4c255060eb15.4747186.8038252012.044051-46774618", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Path:        "pages/index/index",                                                      // 文档中对应字段：path，实际使用时请替换成真实参数
		Width:       532,                                                                      // 文档中对应字段：width，实际使用时请替换成真实参数
		Mf:          0,                                                                        // 文档中对应字段：mf，实际使用时请替换成真实参数
		ImgFlag:     1,                                                                        // 文档中对应字段：img_flag，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetQrCode(reqParams)
	if err != nil {
