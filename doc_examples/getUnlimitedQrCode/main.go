...
func main() {
	...
	reqParams := &openapi.GetUnlimitedQrCodeRequest{
		AccessToken: "21.052f08524a1585a6c7ad5c178605eb73.2807671.2244842377.654274-50384557", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Path:        "pages/index/index",                                                      // 文档中对应字段：path，实际使用时请替换成真实参数
		Width:       562,                                                                      // 文档中对应字段：width，实际使用时请替换成真实参数
		Mf:          0,                                                                        // 文档中对应字段：mf，实际使用时请替换成真实参数
		ImgFlag:     1,                                                                        // 文档中对应字段：img_flag，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetUnlimitedQrCode(reqParams)
	if err != nil {
