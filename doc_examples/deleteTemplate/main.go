...
func main() {
	...
	reqParams := &openapi.DeleteTemplateRequest{
		AccessToken: "22.087f41613a4083a8c8ad1c753472eb54.8705885.4271753560.131500-57481064", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		TemplateID:  "9fe3d25bb4b881581ea4e45f03118a05",                                       // 文档中对应字段：template_id，实际使用时请替换成真实参数
	}

	resp, err := openapi.DeleteTemplate(reqParams)
	if err != nil {
