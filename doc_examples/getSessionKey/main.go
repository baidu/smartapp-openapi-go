...
func main() {
	...
	reqParams := &openapi.GetSessionKeyRequest{
		Code:     "5b643bdb0c73472e40104d4a3ce2f241NW", // 文档中对应字段：code，实际使用时请替换成真实参数
		ClientID: "4fecoAqgCIUtzIyA2FAPgoyrc3oUc41c",   // 文档中对应字段：client_id，实际使用时请替换成真实参数
		Sk:       "rZ3BcWQPSQxS2jhCwSVVx7gfRdNWn1TO",   // 文档中对应字段：sk，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetSessionKey(reqParams)
	if err != nil {
