...
func main() {
	...
	reqParams := &openapi.CheckPathRequest{
		AccessToken: "20.247f63013a8603a3c5ad4c581672eb32.6072735.0064767701.742251-23141522", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Path:        "/pages/article/article?id=15875&amp;type=2",                             // 文档中对应字段：path，实际使用时请替换成真实参数
		Type: []string{
			"risk", "porn", "ocr-word", "ocr-lead",
		}, // 文档中对应字段：type，实际使用时请替换成真实参数
	}

	resp, err := openapi.CheckPath(reqParams)
	if err != nil {
