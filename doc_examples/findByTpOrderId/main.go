...
func main() {
	...
	reqParams := &openapi.FindByTpOrderIDRequest{
		AccessToken: "23.817c8264c03c17665d6efd3f5622ebd7.6277158.3333683178.875845-35685374", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		TpOrderID:   "1428055315487",                                                          // 文档中对应字段：tpOrderId，实际使用时请替换成真实参数
		PmAppKey:    "MMUpGO",                                                                 // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数
	}

	resp, err := openapi.FindByTpOrderID(reqParams)
	if err != nil {
