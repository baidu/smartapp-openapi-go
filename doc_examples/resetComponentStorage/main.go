...
func main() {
	...
	reqParams := &openapi.ResetComponentStorageRequest{
		AccessToken: "20.42f7cf14848b5ea0a3368c75227e4f12.5286666.6631710681.187175-03455650", // 文档中对应字段：access_token，实际使用时请替换成真实参数
	}

	resp, err := openapi.ResetComponentStorage(reqParams)
	if err != nil {
