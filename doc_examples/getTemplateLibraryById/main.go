...
func main() {
	...
	reqParams := &openapi.GetTemplateLibraryByIDRequest{
		AccessToken: "27.1fa218ebfa2c740dda3b6a723c17124e.8548133.6552461780.500262-84053743", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		ID:          "BD1245",                                                                 // 文档中对应字段：id，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetTemplateLibraryByID(reqParams)
	if err != nil {
