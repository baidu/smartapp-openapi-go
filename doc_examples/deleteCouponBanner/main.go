...
func main() {
	...
	reqParams := &openapi.DeleteCouponBannerRequest{
		AccessToken: "26.356f52334a1706a4c0ad5c366647eb67.6521305.4186675224.885102-68435364", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		CouponID:    "8576431651",                                                             // 文档中对应字段：couponId，实际使用时请替换成真实参数
		BannerID:    8704474201,                                                               // 文档中对应字段：bannerId，实际使用时请替换成真实参数
	}

	resp, err := openapi.DeleteCouponBanner(reqParams)
	if err != nil {
