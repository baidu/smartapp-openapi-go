...
func main() {
	...
	reqParams := &openapi.GetLikeCountRequest{
		AccessToken: "23.7e372433ce402eb5bf82c314af74ac41.2615228.5123006603.425324-14240747", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		HostName:    "baiduboxapp",                                                            // 文档中对应字段：host_name，实际使用时请替换成真实参数
		Snid:        "ts_article_c586ed5e61ce35234f5141eb",                                    // 文档中对应字段：snid，实际使用时请替换成真实参数
		SnidType:    "",                                                                       // 文档中对应字段：snid_type，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetLikeCount(reqParams)
	if err != nil {
