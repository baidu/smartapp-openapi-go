...
func main() {
	...
	reqParams := &openapi.CustomSendRequest{
		AccessToken: "",       // 文档中对应字段：access_token，实际使用时请替换成真实参数
		UserType:    1,        // 文档中对应字段：user_type，实际使用时请替换成真实参数
		OpenID:      "xxxxx",  // 文档中对应字段：open_id，实际使用时请替换成真实参数
		MsgType:     "text",   // 文档中对应字段：msg_type，实际使用时请替换成真实参数
		Content:     "百度改变世界", // 文档中对应字段：content，实际使用时请替换成真实参数
		PicURL:      "",       // 文档中对应字段：pic_url，实际使用时请替换成真实参数
	}

	resp, err := openapi.CustomSend(reqParams)
	if err != nil {
