...
func main() {
	...
	reqParams := &openapi.GetCommentCountRequest{
		AccessToken: "27.4e260068ce344eb8bf53c635af83ac64.2017713.6036022706.132234-18731810", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Snid:        "ts_article_c457ed4e61ce70082f6674eb",                                    // 文档中对应字段：snid，实际使用时请替换成真实参数
		SnidType:    "",                                                                       // 文档中对应字段：snid_type，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetCommentCount(reqParams)
	if err != nil {
