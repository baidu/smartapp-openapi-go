...
func main() {
	...
	reqParams := &openapi.GetSessionKeyv2Request{
		AccessToken: "27.711f44887a6127a7c0ad8c554352eb55.8787508.0252460343.084102-45410604", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Code:        "2dc5c702b71387a2604812c35172db53NW",                                     // 文档中对应字段：code，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetSessionKeyv2(reqParams)
	if err != nil {
