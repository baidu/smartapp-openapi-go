...
func main() {
	...
	reqParams := &openapi.OrderBillRequest{
		AccessToken: "20.767c5602c52c35836d8efd5f4570ebd1.1887135.4268145020.106712-41285842", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		BillTime:    "2150-38-68",                                                             // 文档中对应字段：billTime，实际使用时请替换成真实参数
		PmAppKey:    "MMUpGO",                                                                 // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数
	}

	resp, err := openapi.OrderBill(reqParams)
	if err != nil {
