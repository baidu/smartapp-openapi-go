...
func main() {
	...
	reqParams := &msgtemplate.SendMsgRequest{
		AccessToken:  "#token",                                                                          // 文档中对应字段：access_token，实际使用时请替换成真实参数
		TemplateID:   "27a76c3d14314cda4a40cad0ffe05725",                                                // 文档中对应字段：template_id，实际使用时请替换成真实参数
		TouserOpenID: "",                                                                                // 文档中对应字段：touser_openId，实际使用时请替换成真实参数
		Data:         "{\"keyword5\": {\"value\": \"order106372\"},\"keyword3\": {\"value\": \"026\"}}", // 文档中对应字段：data，实际使用时请替换成真实参数
		Page:         "",                                                                                // 文档中对应字段：page，实际使用时请替换成真实参数
		SceneID:      "scene101",                                                                        // 文档中对应字段：scene_id，实际使用时请替换成真实参数
		SceneType:    1,                                                                                 // 文档中对应字段：scene_type，实际使用时请替换成真实参数
		Title:        "title380",                                                                        // 文档中对应字段：title，实际使用时请替换成真实参数
		Ext:          "",                                                                                // 文档中对应字段：ext，实际使用时请替换成真实参数
	}

	resp, err := msgtemplate.SendMsg(reqParams)
	if err != nil {
