...
func main() {
	...
	reqParams := &msgtemplate.AddMsgTemplateRequest{
		AccessToken:   "#token", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		ID:            "BD4620", // 文档中对应字段：id，实际使用时请替换成真实参数
		KeywordIDList: "[5,0]",  // 文档中对应字段：keyword_id_list，实际使用时请替换成真实参数
	}

	resp, err := msgtemplate.AddMsgTemplate(reqParams)
	if err != nil {
