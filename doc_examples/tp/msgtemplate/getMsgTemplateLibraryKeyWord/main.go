...
func main() {
	...
	reqParams := &msgtemplate.GetMsgTemplateLibraryKeyWordRequest{
		AccessToken: "#token", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		ID:          "BD8415", // 文档中对应字段：id，实际使用时请替换成真实参数
	}

	resp, err := msgtemplate.GetMsgTemplateLibraryKeyWord(reqParams)
	if err != nil {
