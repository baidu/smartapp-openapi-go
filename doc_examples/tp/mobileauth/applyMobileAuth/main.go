...
func main() {
	...
	reqParams := &mobileauth.ApplyMobileAuthRequest{
		AccessToken: "#token",                                                                                                  // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Reason:      1,                                                                                                         // 文档中对应字段：reason，实际使用时请替换成真实参数
		UsedScene:   1,                                                                                                         // 文档中对应字段：used_scene，实际使用时请替换成真实参数
		SceneDesc:   "使用场景描述不得超过 212 字",                                                                                        // 文档中对应字段：scene_desc，实际使用时请替换成真实参数
		SceneDemo:   "https://mbs7.bdstatic.com/searchbox/mappconsole/image/11441211/50feb5a0-d47b-423c-0247-32cfff47c3a2.jpg", // 文档中对应字段：scene_demo，实际使用时请替换成真实参数
	}

	resp, err := mobileauth.ApplyMobileAuth(reqParams)
	if err != nil {
