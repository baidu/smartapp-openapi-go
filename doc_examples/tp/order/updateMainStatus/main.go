...
func main() {
	...
	UpdateMainStatusRequestDataItemVal := order.UpdateMainStatusRequestDataItem{
	...
	reqParams := &order.UpdateMainStatusRequest{
		AccessToken: "#token", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		OpenID:      "114",    // 文档中对应字段：open_id，实际使用时请替换成真实参数
		SceneID:     "110",    // 文档中对应字段：scene_id，实际使用时请替换成真实参数
		SceneType:   2,        // 文档中对应字段：scene_type，实际使用时请替换成真实参数
		Data: []order.UpdateMainStatusRequestDataItem{
			UpdateMainStatusRequestDataItemVal,
		}, // 文档中对应字段：Data，实际使用时请替换成真实参数
	}

	resp, err := order.UpdateMainStatus(reqParams)
	if err != nil {
