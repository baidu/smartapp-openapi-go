...
func main() {
	...
	reqParams := &pkg.SubmitPackageAuditRequest{
		AccessToken:  "#token",           // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Content:      "sdk-test-content", // 文档中对应字段：content，实际使用时请替换成真实参数
		PackageID:    "1605142",          // 文档中对应字段：package_id，实际使用时请替换成真实参数
		Remark:       "sdk-test-remark",  // 文档中对应字段：remark，实际使用时请替换成真实参数
		TestAccount:  "",                 // 文档中对应字段：test_account，实际使用时请替换成真实参数
		TestPassword: "",                 // 文档中对应字段：test_password，实际使用时请替换成真实参数
	}

	resp, err := pkg.SubmitPackageAudit(reqParams)
	if err != nil {
