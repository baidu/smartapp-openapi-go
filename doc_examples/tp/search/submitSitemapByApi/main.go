...
func main() {
	...
	reqParams := &search.SubmitSitemapByAPIRequest{
		AccessToken: "#tpToken",       // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Type:        0,                // 文档中对应字段：type，实际使用时请替换成真实参数
		URLList:     "submit/sitemap", // 文档中对应字段：url_list，实际使用时请替换成真实参数
	}

	resp, err := search.SubmitSitemapByAPI(reqParams)
	if err != nil {
