...
func main() {
	...
	reqParams := &search.UpdateSubChainRequest{
		AccessToken: "#token",     // 文档中对应字段：access_token，实际使用时请替换成真实参数
		SubchainID:  "124",        // 文档中对应字段：subchain_id，实际使用时请替换成真实参数
		ChainName:   "chainName",  // 文档中对应字段：chain_name，实际使用时请替换成真实参数
		ChainDesc:   "chainDesc",  // 文档中对应字段：chain_desc，实际使用时请替换成真实参数
		ChainPath:   "/chainPath", // 文档中对应字段：chain_path，实际使用时请替换成真实参数
		Telephone:   "13531",      // 文档中对应字段：telephone，实际使用时请替换成真实参数
	}

	resp, err := search.UpdateSubChain(reqParams)
	if err != nil {
