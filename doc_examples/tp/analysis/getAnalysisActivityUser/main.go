...
func main() {
	...
	reqParams := &analysis.GetAnalysisActivityUserRequest{
		AccessToken: "#token",   // 文档中对应字段：access_token，实际使用时请替换成真实参数
		StartIndex:  0,          // 文档中对应字段：start_index，实际使用时请替换成真实参数
		StartDate:   "22104851", // 文档中对应字段：start_date，实际使用时请替换成真实参数
		EndDate:     "26308111", // 文档中对应字段：end_date，实际使用时请替换成真实参数
	}

	resp, err := analysis.GetAnalysisActivityUser(reqParams)
	if err != nil {
