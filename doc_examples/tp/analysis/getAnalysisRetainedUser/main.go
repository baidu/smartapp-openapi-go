...
func main() {
	...
	reqParams := &analysis.GetAnalysisRetainedUserRequest{
		AccessToken: "#token",   // 文档中对应字段：access_token，实际使用时请替换成真实参数
		ReportType:  "count",    // 文档中对应字段：report_type，实际使用时请替换成真实参数
		StartIndex:  0,          // 文档中对应字段：start_index，实际使用时请替换成真实参数
		StartDate:   "24051472", // 文档中对应字段：start_date，实际使用时请替换成真实参数
		EndDate:     "27411407", // 文档中对应字段：end_date，实际使用时请替换成真实参数
		Gran:        "month",    // 文档中对应字段：gran，实际使用时请替换成真实参数
	}

	resp, err := analysis.GetAnalysisRetainedUser(reqParams)
	if err != nil {
