...
func main() {
	...
	reqParams := &analysis.GetAnalysisUserTrendRequest{
		AccessToken: "#token",   // 文档中对应字段：access_token，实际使用时请替换成真实参数
		StartIndex:  0,          // 文档中对应字段：start_index，实际使用时请替换成真实参数
		StartDate:   "23505084", // 文档中对应字段：start_date，实际使用时请替换成真实参数
		EndDate:     "24821044", // 文档中对应字段：end_date，实际使用时请替换成真实参数
		Gran:        "month",    // 文档中对应字段：gran，实际使用时请替换成真实参数
	}

	resp, err := analysis.GetAnalysisUserTrend(reqParams)
	if err != nil {
