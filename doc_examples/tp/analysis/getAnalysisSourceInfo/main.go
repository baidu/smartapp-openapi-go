...
func main() {
	...
	reqParams := &analysis.GetAnalysisSourceInfoRequest{
		AccessToken: "#token",   // 文档中对应字段：access_token，实际使用时请替换成真实参数
		StartIndex:  0,          // 文档中对应字段：start_index，实际使用时请替换成真实参数
		StartDate:   "25658036", // 文档中对应字段：start_date，实际使用时请替换成真实参数
		EndDate:     "27205222", // 文档中对应字段：end_date，实际使用时请替换成真实参数
	}

	resp, err := analysis.GetAnalysisSourceInfo(reqParams)
	if err != nil {
