...
func main() {
	...
	reqParams := &analysis.GetAnalysisVisitPageRequest{
		AccessToken: "#token",   // 文档中对应字段：access_token，实际使用时请替换成真实参数
		StartIndex:  0,          // 文档中对应字段：start_index，实际使用时请替换成真实参数
		StartDate:   "24834887", // 文档中对应字段：start_date，实际使用时请替换成真实参数
		EndDate:     "24455321", // 文档中对应字段：end_date，实际使用时请替换成真实参数
	}

	resp, err := analysis.GetAnalysisVisitPage(reqParams)
	if err != nil {
