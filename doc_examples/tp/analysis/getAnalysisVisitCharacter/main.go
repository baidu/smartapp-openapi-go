...
func main() {
	...
	reqParams := &analysis.GetAnalysisVisitCharacterRequest{
		AccessToken:   "#token",   // 文档中对应字段：access_token，实际使用时请替换成真实参数
		CharacterType: "time",     // 文档中对应字段：character_type，实际使用时请替换成真实参数
		StartIndex:    0,          // 文档中对应字段：start_index，实际使用时请替换成真实参数
		StartDate:     "22246843", // 文档中对应字段：start_date，实际使用时请替换成真实参数
		EndDate:       "23125353", // 文档中对应字段：end_date，实际使用时请替换成真实参数
	}

	resp, err := analysis.GetAnalysisVisitCharacter(reqParams)
	if err != nil {
