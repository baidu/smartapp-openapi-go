...
func main() {
	...
	reqParams := &analysis.GetAnalysisVisitAttributeRequest{
		AccessToken: "#token",   // 文档中对应字段：access_token，实际使用时请替换成真实参数
		StartDate:   "24553570", // 文档中对应字段：start_date，实际使用时请替换成真实参数
		EndDate:     "27488344", // 文档中对应字段：end_date，实际使用时请替换成真实参数
	}

	resp, err := analysis.GetAnalysisVisitAttribute(reqParams)
	if err != nil {
