...
func main() {
	...
	reqParams := &customermsg.SendCustomerMessageRequest{
		AccessToken: "#token",                                                                                                  // 文档中对应字段：access_token，实际使用时请替换成真实参数
		UserType:    1,                                                                                                         // 文档中对应字段：user_type，实际使用时请替换成真实参数
		OpenID:      "#openid",                                                                                                 // 文档中对应字段：open_id，实际使用时请替换成真实参数
		MsgType:     "text",                                                                                                    // 文档中对应字段：msg_type，实际使用时请替换成真实参数
		Content:     "content",                                                                                                 // 文档中对应字段：content，实际使用时请替换成真实参数
		PicURL:      "https://mbs7.bdstatic.com/searchbox/mappconsole/image/35423816/06feb8a1-d65b-667c-6282-66cfff76c4a7.jpg", // 文档中对应字段：pic_url，实际使用时请替换成真实参数
	}

	resp, err := customermsg.SendCustomerMessage(reqParams)
	if err != nil {
