...
func main() {
	...
	reqParams := &app.CheckAppNickNameRequest{
		AccessToken:   "#token", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		AppName:       "baidu",  // 文档中对应字段：app_name，实际使用时请替换成真实参数
		QualMaterials: "",       // 文档中对应字段：qual_materials，实际使用时请替换成真实参数
	}

	resp, err := app.CheckAppNickName(reqParams)
	if err != nil {
