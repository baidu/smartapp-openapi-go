...
func main() {
	...
	reqParams := &app.SetAppImageRequest{
		AccessToken: "#token",                                                                                                  // 文档中对应字段：access_token，实际使用时请替换成真实参数
		ImageURL:    "https://mbs2.bdstatic.com/searchbox/mappconsole/image/17564658/85feb8a1-d25b-033c-8476-10cfff30c3a7.jpg", // 文档中对应字段：image_url，实际使用时请替换成真实参数
	}

	resp, err := app.SetAppImage(reqParams)
	if err != nil {
