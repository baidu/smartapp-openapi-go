...
func main() {
	...
	reqParams := &app.SetAppDomainRequest{
		AccessToken:    "#token", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Action:         "get",    // 文档中对应字段：action，实际使用时请替换成真实参数
		DownloadDomain: "",       // 文档中对应字段：download_domain，实际使用时请替换成真实参数
		RequestDomain:  "",       // 文档中对应字段：request_domain，实际使用时请替换成真实参数
		SocketDomain:   "",       // 文档中对应字段：socket_domain，实际使用时请替换成真实参数
		UploadDomain:   "",       // 文档中对应字段：upload_domain，实际使用时请替换成真实参数
	}

	resp, err := app.SetAppDomain(reqParams)
	if err != nil {
