...
func main() {
	...
	reqParams := &offline.SetAppOfflineRequest{
		AccessToken:     "#token", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		AppName:         "",       // 文档中对应字段：app_name，实际使用时请替换成真实参数
		AppDesc:         "",       // 文档中对应字段：app_desc，实际使用时请替换成真实参数
		PhotoAddr:       "",       // 文档中对应字段：photo_addr，实际使用时请替换成真实参数
		AppNameMaterial: "",       // 文档中对应字段：app_name_material，实际使用时请替换成真实参数
	}

	resp, err := offline.SetAppOffline(reqParams)
	if err != nil {
