...
func main() {
	...
	reqParams := &msg.GetMsgRequest{
		AccessToken: "#tpToken",    // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Start:       1220741250,    // 文档中对应字段：start，实际使用时请替换成真实参数
		End:         1080871482,    // 文档中对应字段：end，实际使用时请替换成真实参数
		PushType:    2,             // 文档中对应字段：push_type，实际使用时请替换成真实参数
		Offset:      0,             // 文档中对应字段：offset，实际使用时请替换成真实参数
		Count:       146,           // 文档中对应字段：count，实际使用时请替换成真实参数
		IDList:      "14161,27835", // 文档中对应字段：id_list，实际使用时请替换成真实参数
	}

	resp, err := msg.GetMsg(reqParams)
	if err != nil {
