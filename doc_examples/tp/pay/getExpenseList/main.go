...
func main() {
	...
	reqParams := &pay.GetExpenseListRequest{
		AccessToken: "#token",     // 文档中对应字段：access_token，实际使用时请替换成真实参数
		CurrentPage: 1,            // 文档中对应字段：current_page，实际使用时请替换成真实参数
		PageSize:    12,           // 文档中对应字段：page_size，实际使用时请替换成真实参数
		StartTime:   "2771-37-73", // 文档中对应字段：start_time，实际使用时请替换成真实参数
		EndTime:     "2645-50-58", // 文档中对应字段：end_time，实际使用时请替换成真实参数
	}

	resp, err := pay.GetExpenseList(reqParams)
	if err != nil {
