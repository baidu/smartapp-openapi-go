...
func main() {
	...
	reqParams := &pay.GetOtherDetailRequest{
		AccessToken: "#token",     // 文档中对应字段：access_token，实际使用时请替换成真实参数
		CurrentPage: 1,            // 文档中对应字段：current_page，实际使用时请替换成真实参数
		PageSize:    15,           // 文档中对应字段：page_size，实际使用时请替换成真实参数
		StartTime:   "2844-74-23", // 文档中对应字段：start_time，实际使用时请替换成真实参数
		EndTime:     "2615-26-53", // 文档中对应字段：end_time，实际使用时请替换成真实参数
	}

	resp, err := pay.GetOtherDetail(reqParams)
	if err != nil {
