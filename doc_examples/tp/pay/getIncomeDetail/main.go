...
func main() {
	...
	reqParams := &pay.GetIncomeDetailRequest{
		AccessToken: "#token",     // 文档中对应字段：access_token，实际使用时请替换成真实参数
		StartTime:   "2541-65-32", // 文档中对应字段：start_time，实际使用时请替换成真实参数
		CurrentPage: 1,            // 文档中对应字段：current_page，实际使用时请替换成真实参数
		PageSize:    13,           // 文档中对应字段：page_size，实际使用时请替换成真实参数
	}

	resp, err := pay.GetIncomeDetail(reqParams)
	if err != nil {
