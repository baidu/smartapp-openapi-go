...
func main() {
	...
	reqParams := &pay.GetOrderListRequest{
		AccessToken: "#token",    // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Status:      "1",         // 文档中对应字段：status，实际使用时请替换成真实参数
		StartTime:   10356534384, // 文档中对应字段：start_time，实际使用时请替换成真实参数
		EndTime:     16541104262, // 文档中对应字段：end_time，实际使用时请替换成真实参数
		CurrentPage: 1,           // 文档中对应字段：current_page，实际使用时请替换成真实参数
		PageSize:    10,          // 文档中对应字段：page_size，实际使用时请替换成真实参数
	}

	resp, err := pay.GetOrderList(reqParams)
	if err != nil {
