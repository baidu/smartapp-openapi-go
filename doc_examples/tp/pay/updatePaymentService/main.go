...
func main() {
	...
	reqParams := &pay.UpdatePaymentServiceRequest{
		AccessToken:    "#token",      // 文档中对应字段：access_token，实际使用时请替换成真实参数
		AppName:        "智能小程序",       // 文档中对应字段：app_name，实际使用时请替换成真实参数
		ServicePhone:   "14438632138", // 文档中对应字段：service_phone，实际使用时请替换成真实参数
		PoolCashPledge: 184,           // 文档中对应字段：pool_cash_pledge，实际使用时请替换成真实参数
	}

	resp, err := pay.UpdatePaymentService(reqParams)
	if err != nil {
