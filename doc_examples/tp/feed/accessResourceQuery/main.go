...
func main() {
	...
	reqParams := &feed.AccessResourceQueryRequest{
		AccessToken: "#token",            // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Begin:       1505380052,          // 文档中对应字段：begin，实际使用时请替换成真实参数
		End:         1673574458,          // 文档中对应字段：end，实际使用时请替换成真实参数
		ImageType:   0,                   // 文档中对应字段：image_type，实际使用时请替换成真实参数
		PageNo:      1,                   // 文档中对应字段：page_no，实际使用时请替换成真实参数
		PageSize:    16,                  // 文档中对应字段：page_size，实际使用时请替换成真实参数
		Status:      0,                   // 文档中对应字段：status，实际使用时请替换成真实参数
		Title:       "百度智能小程序，给你全新的智能体验", // 文档中对应字段：title，实际使用时请替换成真实参数
	}

	resp, err := feed.AccessResourceQuery(reqParams)
	if err != nil {
