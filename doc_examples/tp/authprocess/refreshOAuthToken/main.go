...
func main() {
	...
	reqParams := &authprocess.RefreshOAuthTokenRequest{
		AccessToken:  "#tpToken",                // 文档中对应字段：access_token，实际使用时请替换成真实参数
		RefreshToken: "",                        // 文档中对应字段：refresh_token，实际使用时请替换成真实参数
		GrantType:    "app_to_tp_refresh_token", // 文档中对应字段：grant_type，实际使用时请替换成真实参数
	}

	resp, err := authprocess.RefreshOAuthToken(reqParams)
	if err != nil {
