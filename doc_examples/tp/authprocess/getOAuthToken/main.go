...
func main() {
	...
	reqParams := &authprocess.GetOAuthTokenRequest{
		AccessToken: "#tpToken",                         // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Code:        "f4c34656cc670a8f8c48181f7140bb30", // 文档中对应字段：code，实际使用时请替换成真实参数
		GrantType:   "app_to_tp_authorization_code",     // 文档中对应字段：grant_type，实际使用时请替换成真实参数
	}

	resp, err := authprocess.GetOAuthToken(reqParams)
	if err != nil {
