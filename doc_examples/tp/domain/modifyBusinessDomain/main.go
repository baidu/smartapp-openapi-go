...
func main() {
	...
	reqParams := &domain.ModifyBusinessDomainRequest{
		AccessToken:   "#tpToken",             // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Action:        "get",                  // 文档中对应字段：action，实际使用时请替换成真实参数
		WebViewDomain: "http://www.baidu.com", // 文档中对应字段：web_view_domain，实际使用时请替换成真实参数
	}

	resp, err := domain.ModifyBusinessDomain(reqParams)
	if err != nil {
