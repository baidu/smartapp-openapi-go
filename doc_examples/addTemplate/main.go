...
func main() {
	...
	reqParams := &openapi.AddTemplateRequest{
		AccessToken:   "26.3fa264ebfa1c368dda7b8a354c67447e.2047555.5624530873.118630-81031654", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		ID:            "BD4837",                                                                 // 文档中对应字段：id，实际使用时请替换成真实参数
		KeywordIDList: "[2,8,3]",                                                                // 文档中对应字段：keyword_id_list，实际使用时请替换成真实参数
	}

	resp, err := openapi.AddTemplate(reqParams)
	if err != nil {
