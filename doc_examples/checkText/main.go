...
func main() {
	...
	reqParams := &openapi.CheckTextRequest{
		AccessToken: "25.137f71565a5813a8c5ad7c705780eb21.7414138.1488113578.106823-78438686", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Content:     "待检测文本",                                                                  // 文档中对应字段：content，实际使用时请替换成真实参数
		Type: []string{
			"risk", "lead",
		}, // 文档中对应字段：type，实际使用时请替换成真实参数
	}

	resp, err := openapi.CheckText(reqParams)
	if err != nil {
