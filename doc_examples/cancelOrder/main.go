...
func main() {
	...
	reqParams := &openapi.CancelOrderRequest{
		AccessToken: "23.678c5186c16c14253d0efd8f8703ebd3.0417327.1672107322.351550-47358565", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		OrderID:     1847515250875,                                                            // 文档中对应字段：orderId，实际使用时请替换成真实参数
		PmAppKey:    "MMUpGO",                                                                 // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数
	}

	resp, err := openapi.CancelOrder(reqParams)
	if err != nil {
