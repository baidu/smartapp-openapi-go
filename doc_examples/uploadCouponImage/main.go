...
func main() {
	...
	uploadCouponImageRequestFileVal := openapi.UploadCouponImageRequestFile{
		Name:   "file",
		Reader: fileReader,
	}
	reqParams := &openapi.UploadCouponImageRequest{
		AccessToken: "22.301f80736a3622a7c8ad0c581248eb53.0117372.0360128810.554556-13405033", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		File:        uploadCouponImageRequestFileVal,                                          // 文档中对应字段：file，实际使用时请替换成真实参数
	}

	resp, err := openapi.UploadCouponImage(reqParams)
	if err != nil {
