...
func main() {
	...
	reqParams := &openapi.GetTemplateListRequest{
		AccessToken: "20.0fa443ebfa8c811dda2b5a407c70630e.1113351.7815234724.772605-87834752", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Offset:      0,                                                                        // 文档中对应字段：offset，实际使用时请替换成真实参数
		Count:       3,                                                                        // 文档中对应字段：count，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetTemplateList(reqParams)
	if err != nil {
