...
func main() {
	...
	reqParams := &openapi.GetTemplateLibraryListRequest{
		AccessToken: "20.2fa743ebfa2c268dda0b1a688c63878e.6545307.5316687272.107366-28400736", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Offset:      0,                                                                        // 文档中对应字段：offset，实际使用时请替换成真实参数
		Count:       3,                                                                        // 文档中对应字段：count，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetTemplateLibraryList(reqParams)
	if err != nil {
