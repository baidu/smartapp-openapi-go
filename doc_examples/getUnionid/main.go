...
func main() {
	...
	reqParams := &openapi.GetUnionidRequest{
		AccessToken: "23.784f67726a8107a2c8ad8c438128eb04.8788110.2317057360.613155-54426382", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		Openid:      "k41HEREQhWhWWB0WYqYT1ITUGX",                                             // 文档中对应字段：openid，实际使用时请替换成真实参数
	}

	resp, err := openapi.GetUnionid(reqParams)
	if err != nil {
