...
func main() {
	...
	reqParams := &openapi.CapitaBillRequest{
		AccessToken: "27.188c5788c40c71756d2efd5f3488ebd2.6152723.2708265320.377085-35286378", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		BillTime:    "2035-53-34",                                                             // 文档中对应字段：billTime，实际使用时请替换成真实参数
		PmAppKey:    "MMUpGO",                                                                 // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数
	}

	resp, err := openapi.CapitaBill(reqParams)
	if err != nil {
