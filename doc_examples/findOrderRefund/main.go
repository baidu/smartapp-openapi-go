...
func main() {
	...
	reqParams := &openapi.FindOrderRefundRequest{
		AccessToken: "21.522c4675c08c50341d3efd4f0474ebd0.2063280.7337607050.112878-57133166", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		TpOrderID:   "1823718880315",                                                          // 文档中对应字段：tpOrderId，实际使用时请替换成真实参数
		UserID:      1533804,                                                                  // 文档中对应字段：userId，实际使用时请替换成真实参数
		PmAppKey:    "MMUpGO",                                                                 // 文档中对应字段：pmAppKey，实际使用时请替换成真实参数
	}

	resp, err := openapi.FindOrderRefund(reqParams)
	if err != nil {
