...
func main() {
	...
	reqParams := &openapi.DeleteMaterialRequest{
		AccessToken: "27.1fa263ebfa5c286dda3b5a645c08828e.3878657.7253675826.461386-72580500", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		AppID:       13788733,                                                                 // 文档中对应字段：app_id，实际使用时请替换成真实参数
		ID:          12631,                                                                    // 文档中对应字段：id，实际使用时请替换成真实参数
		Path:        "/pages/index/index",                                                     // 文档中对应字段：path，实际使用时请替换成真实参数
	}

	resp, err := openapi.DeleteMaterial(reqParams)
	if err != nil {
