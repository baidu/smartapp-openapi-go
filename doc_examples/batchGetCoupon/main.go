...
func main() {
	...
	reqParams := &openapi.BatchGetCouponRequest{
		AccessToken: "25.031f27431a1422a1c1ad7c208070eb43.0268631.0562372674.126517-53841046", // 文档中对应字段：access_token，实际使用时请替换成真实参数
	}

	resp, err := openapi.BatchGetCoupon(reqParams)
	if err != nil {
