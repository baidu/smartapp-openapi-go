...
func main() {
	...
	reqParams := &openapi.DeleteSkuCouponRequest{
		AccessToken: "23.bdc48bb3af2573e22b220f3466b66f50.6400284.8128586574.371426-550068186", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		AppID:       127422802,                                                                 // 文档中对应字段：app_id，实际使用时请替换成真实参数
		PathList:    "[\"/pages/detail/detail?id=568623\"]",                                    // 文档中对应字段：path_list，实际使用时请替换成真实参数
	}

	resp, err := openapi.DeleteSkuCoupon(reqParams)
	if err != nil {
