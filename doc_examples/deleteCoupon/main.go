...
func main() {
	...
	reqParams := &openapi.DeleteCouponRequest{
		AccessToken: "26.381f15475a8601a7c0ad3c212564eb68.4666834.2783850380.421774-80844481", // 文档中对应字段：access_token，实际使用时请替换成真实参数
		CouponID:    "8468845870",                                                             // 文档中对应字段：couponId，实际使用时请替换成真实参数
	}

	resp, err := openapi.DeleteCoupon(reqParams)
	if err != nil {
