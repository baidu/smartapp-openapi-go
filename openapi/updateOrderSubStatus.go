...
func UpdateOrderSubStatus(params *UpdateOrderSubStatusRequest) ([]UpdateOrderSubStatusResponsedataItem, error) {
	var (
		err        error
		defaultRet []UpdateOrderSubStatusResponsedataItem
	)
	respData := &UpdateOrderSubStatusResponse{}
	...
	client := NewHTTPClient().
		...
		SetScheme(SCHEME).
		SetHost(OPENAPIHOST).
		SetPath("/rest/2.0/smartapp/ordercenter/app/update/sub/status")
