...
type CreatePaymentServiceResponse struct {
	Data      CreatePaymentServiceResponsedata `json:"data"`       // 响应参数
...
func CreatePaymentService(params *CreatePaymentServiceRequest) (*CreatePaymentServiceResponsedata, error) {
	var (
		err        error
		defaultRet *CreatePaymentServiceResponsedata
	)
	respData := &CreatePaymentServiceResponse{}
	...
	client := utils.NewHTTPClient().
		...
		SetPath("/rest/2.0/smartapp/pay/paymentservice/create")
